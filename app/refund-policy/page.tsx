        ...
        <main>
            ...
            <div className="px-4 text-gray-800 space-y-4 py-8">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <strong>Goods</strong> refer to the items offered
                ...
                <p>
                    ...
                    on which You received the Goods or on which a third party
                    you have appointed, who is not the carrier, takes possession
                ...
                <ul>
                    ...
                    <li>
                        ...
                        not suitable to be returned, deteriorate rapidly or
                        where the date of expiry is over.
                    </li>
                    <li>
                        The supply of Goods which are not suitable for return
